...
impl HideHeavenStemDay {
    pub fn new(hide_heaven_stem: HideHeavenStem, day_index: usize) -> Self {
        let culture: AbstractCulture = hide_heaven_stem.clone().into();
        Self {
...
impl SixtyCycleDay {
    pub fn from_solar_day(solar_day: SolarDay) -> Self {
        ...
        Self {
            solar_day,
            month: SixtyCycleYear::from_year(term.get_year())
                .get_first_month()
                .next(offset),
...
impl SixtyCycleHour {
    pub fn from_solar_time(solar_time: SolarTime) -> Self {
        ...
        if lunar_year.get_year() == solar_year && solar_time.is_before(spring_solar_time) {
        ...
        Self {
            ...
            day: SixtyCycleDay {
                ...
                month: SixtyCycleMonth {
                    ...
                    month: m
                        .get_sixty_cycle()
                        .next((index as f64 * 0.5).floor() as isize),
                },
                day: d,
            },
